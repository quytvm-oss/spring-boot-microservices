...
import org.example.notifierservice.domain.OrderEventEntity;
import org.example.notifierservice.domain.OrderEventRepository;
import org.example.notifierservice.domain.models.OrderCancelledEvent;
import org.example.notifierservice.domain.models.OrderCreatedEvent;
import org.example.notifierservice.domain.models.OrderDeliveredEvent;
import org.example.notifierservice.domain.models.OrderErrorEvent;
...
public class OrderEventHandler {
    ...
    @RabbitListener(queues = "${notifier.new-orders-queue}")
    ...
    @RabbitListener(queues = "${notifier.delivered-orders-queue}")
    ...
    @RabbitListener(queues = "${notifier.cancelled-orders-queue}")
    ...
    @RabbitListener(queues = "${notifier.error-orders-queue}")
